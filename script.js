...
const scrollActive = () => {
    ...
    sections.forEach(current => {
        const sectionHeight = current.offetHeight,
        sectionTop = current.offsetTop - 58,
        sectionId = getAttribute(''),
...
const currentIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-moon-line' : 'ri-sun-line'
if(selectedTheme){
...
sr.reveal(`.discount--description`, {origin: 'right'})